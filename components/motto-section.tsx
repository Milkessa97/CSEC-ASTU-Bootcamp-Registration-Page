  ...
  const principles = [
    {
      number: "03",
      titleParts: [
        { text: bootcampConfig.motto.tagline.split(" ").slice(0, -2).join(" ") + " ", highlight: false },
        { text: bootcampConfig.motto.tagline.split(" ").slice(-2).join(" "), highlight: true },
      ],
      description: bootcampConfig.motto.description,
      align: "left" as const,
    },
    {
      number: "04",
      titleParts: [
        { text: bootcampConfig.motto.subTagline.split(" ").slice(0, -2).join(" ") + " ", highlight: false },
        { text: bootcampConfig.motto.subTagline.split(" ").slice(-2).join(" "), highlight: true },
      ],
      description: bootcampConfig.motto.subDescription,
  ...
  return (
    <section ref={sectionRef} id="principles" className="relative py-32 pl-6 md:pl-28 pr-6 md:pr-12">
      ...
      <div ref={headerRef} className="mb-24">
        <span className="font-mono text-[10px] uppercase tracking-[0.3em] text-accent">03 / Motto</span>
        <h2 className="mt-4 font-[var(--font-bebas)] text-5xl md:text-7xl tracking-tight">OUR MOTTO</h2>
      </div>
