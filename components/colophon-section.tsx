  ...
  return (
    ...
    >
      ...
      <div ref={headerRef} className="mb-16">
        <span className="font-mono text-[10px] uppercase tracking-[0.3em] text-accent">05 / Credits</span>
      ...
      <div ref={gridRef} className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-8 md:gap-12">
        ...
        <div className="col-span-1">
          <h4 className="font-mono text-[9px] uppercase tracking-[0.3em] text-muted-foreground mb-4">Design & CBD</h4>
          <ul className="space-y-2">
            <li className="font-mono text-xs text-foreground/80">CSEC ASTU</li>
            <li className="font-mono text-xs text-foreground/80">Capacity Building</li>
          </ul>
        </div>
        ...
        <div className="col-span-1">
          ...
          <ul className="space-y-2">
            <li className="font-mono text-xs text-foreground/80">ASTU Campus</li>
            <li className="font-mono text-xs text-foreground/80">Adama, Ethiopia</li>
          </ul>
        </div>

        {/* Contact / Socials */}
        <div className="col-span-1">
          <h4 className="font-mono text-[9px] uppercase tracking-[0.3em] text-muted-foreground mb-4">Socials</h4>
        ...
        <div className="col-span-1">
          ...
          <ul className="space-y-2">
            ...
            <li className="font-mono text-xs text-foreground/80">Bootcamp V1</li>
          </ul>
        </div>
      </div>
      ...
      >
        <p className="font-mono text-[10px] text-muted-foreground uppercase tracking-widest">
          © 2026 CSEC ASTU. All rights reserved.
        </p>
        <p className="font-mono text-[10px] text-muted-foreground">Empowering high school students to shape the future with code.</p>
      </div>
    </section>
  )
}
